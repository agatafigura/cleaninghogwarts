...
function displayStudent(student) {
    ...
    if (student.lastname.includes("-")) {
        clone.querySelector("[data-field=photo] img").src = `${student.lastname.substring(student.lastname.indexOf("-") + 1)}_${student.firstname[0]}.png`
        console.log(document.querySelector("[data-field=photo] img".src));
    } else if (student.lastname.includes("Patil")) {
        clone.querySelector("[data-field=photo] img").src = `${student.lastname}_${student.firstname}.png`;
    } else {
         clone.querySelector("[data-field=photo] img").src = `${student.lastname}_${student.firstname[0]}.png`
    }
